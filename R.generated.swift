...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    static let callCaf = Rswift.FileResource(bundle: R.hostingBundle, name: "call", pathExtension: "caf")
    /// Resource file `camera.wav`.
    static let cameraWav = Rswift.FileResource(bundle: R.hostingBundle, name: "camera", pathExtension: "wav")
    /// Resource file `chat.json`.
    static let chatJson = Rswift.FileResource(bundle: R.hostingBundle, name: "chat", pathExtension: "json")
    /// Resource file `close.wav`.
    static let closeWav = Rswift.FileResource(bundle: R.hostingBundle, name: "close", pathExtension: "wav")
    /// Resource file `contact.json`.
    static let contactJson = Rswift.FileResource(bundle: R.hostingBundle, name: "contact", pathExtension: "json")
    /// Resource file `country_code.txt`.
    static let country_codeTxt = Rswift.FileResource(bundle: R.hostingBundle, name: "country_code", pathExtension: "txt")
    /// Resource file `hello.amr`.
    static let helloAmr = Rswift.FileResource(bundle: R.hostingBundle, name: "hello", pathExtension: "amr")
    /// Resource file `message.json`.
    static let messageJson = Rswift.FileResource(bundle: R.hostingBundle, name: "message", pathExtension: "json")
    /// Resource file `moments.json`.
    static let momentsJson = Rswift.FileResource(bundle: R.hostingBundle, name: "moments", pathExtension: "json")
    /// Resource file `msg.caf`.
    static let msgCaf = Rswift.FileResource(bundle: R.hostingBundle, name: "msg", pathExtension: "caf")
    /// Resource file `msgtoolong.wav`.
    static let msgtoolongWav = Rswift.FileResource(bundle: R.hostingBundle, name: "msgtoolong", pathExtension: "wav")
    /// Resource file `pstncall.mp3`.
    static let pstncallMp3 = Rswift.FileResource(bundle: R.hostingBundle, name: "pstncall", pathExtension: "mp3")
    /// Resource file `sendmsg.caf`.
    static let sendmsgCaf = Rswift.FileResource(bundle: R.hostingBundle, name: "sendmsg", pathExtension: "caf")
    /// Resource file `shake_match.wav`.
    static let shake_matchWav = Rswift.FileResource(bundle: R.hostingBundle, name: "shake_match", pathExtension: "wav")
    /// Resource file `shake_nomatch.wav`.
    static let shake_nomatchWav = Rswift.FileResource(bundle: R.hostingBundle, name: "shake_nomatch", pathExtension: "wav")
    /// Resource file `shake_sound_male.wav`.
    static let shake_sound_maleWav = Rswift.FileResource(bundle: R.hostingBundle, name: "shake_sound_male", pathExtension: "wav")
    ...
    /// `bundle.url(forResource: "call", withExtension: "caf")`
    static func callCaf(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.callCaf
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "camera", withExtension: "wav")`
    static func cameraWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.cameraWav
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "chat", withExtension: "json")`
    static func chatJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.chatJson
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "close", withExtension: "wav")`
    static func closeWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.closeWav
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "contact", withExtension: "json")`
    static func contactJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.contactJson
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "country_code", withExtension: "txt")`
    static func country_codeTxt(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.country_codeTxt
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "hello", withExtension: "amr")`
    static func helloAmr(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.helloAmr
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "message", withExtension: "json")`
    static func messageJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.messageJson
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "moments", withExtension: "json")`
    static func momentsJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.momentsJson
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "msg", withExtension: "caf")`
    static func msgCaf(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.msgCaf
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "msgtoolong", withExtension: "wav")`
    static func msgtoolongWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.msgtoolongWav
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "pstncall", withExtension: "mp3")`
    static func pstncallMp3(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.pstncallMp3
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "sendmsg", withExtension: "caf")`
    static func sendmsgCaf(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.sendmsgCaf
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "shake_match", withExtension: "wav")`
    static func shake_matchWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.shake_matchWav
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "shake_nomatch", withExtension: "wav")`
    static func shake_nomatchWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.shake_nomatchWav
      return fileResource.bundle.url(forResource: fileResource)
    }
    
    /// `bundle.url(forResource: "shake_sound_male", withExtension: "wav")`
    static func shake_sound_maleWav(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.shake_sound_maleWav
      return fileResource.bundle.url(forResource: fileResource)
    }
